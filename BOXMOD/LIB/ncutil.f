...
! INTERNAL VARIABLES
      ...
      IF(debug_nc_fg) print*,"open_ncfile_new : ",filename,ncid
...
! INTERNAL VARIABLES
      ...
      IF(debug_nc_fg) print*,"open_ncfile_readwrite : ",filename,ncid
...
! INTERNAL VARIABLES
      ...
      IF(debug_nc_fg) print*,"open_ncfile_writedata : ",filename,ncid
...
! INTERNAL VARIABLES
      ...
      IF(debug_nc_fg) print*,"sync_ncfile : ",ncid
...
! INTERNAL VARIABLES
      ...
      IF(debug_nc_fg) print*,"close_ncfile : ",ncid
...
! INTERNAL VARIABLES
      ...
      IF(debug_nc_fg) print*,"switch_ncfile_to_data_mode : ",ncid
...
! INTERNAL VARIABLES
      ...
      IF(debug_nc_fg)print*,"switch_ncfile_to_define_mode : ",ncid
...
! INTERNAL VARIABLES
      ...
      IF(debug_nc_fg) print*,"eznc_def_dim_unlim:",DimName
...
! INTERNAL VARIABLES
      ...
      IF(debug_nc_fg)print*,"eznc_def_0Dint:",VarName
...
! INTERNAL VARIABLES
      ...
      IF(debug_nc_fg)print*,"eznc_def_0Dreal:",VarName
...
! INTERNAL VARIABLES
      ...
      IF(debug_nc_fg)print*,"eznc_def_1Dint:",VarName,"(",DimName,")"
...
! INTERNAL VARIABLES
      ...
      IF(debug_nc_fg)print*,"eznc_def_1Dreal:",VarName,"(",DimName,")"
...
! INTERNAL VARIABLES
      ...
      IF(debug_nc_fg)print*,"eznc_def_1Dchar:",VarName
...
! INTERNAL VARIABLES
      ...
      IF(debug_nc_fg)print*,"eznc_def_2Ddbl:",VarName
...
! INTERNAL VARIABLES
      ...
      IF(debug_nc_fg)print*,"eznc_def_2Dchar:",VarName
...
! INTERNAL VARIABLES
      ...
      IF(debug_nc_fg) print*,"eznc_put_0Dint:",VarName,value
...
! INTERNAL VARIABLES
      ...
      IF(debug_nc_fg)print*,"eznc_put_0Dreal:",VarName,value
...
! INTERNAL VARIABLES
      ...
      IF(debug_nc_fg)print*,"eznc_put_1Dint:",VarName
...
! INTERNAL VARIABLES
      ...
      IF(debug_nc_fg)print*,"eznc_put_1Dreal:",VarName !,invals
...
! INTERNAL VARIABLES
      ...
      IF(debug_nc_fg)print*,"eznc_put_1Dchar:",VarName
      count1=end1-start1+1
...
! INTERNAL VARIABLES
      ...
      IF(debug_nc_fg)print*,"eznc_put_2Dint:",VarName
...
! INTERNAL VARIABLES
      ...
      IF(debug_nc_fg)print*,"eznc_put_2Dreal:",VarName
...
! INTERNAL VARIABLES
      ...
      IF(debug_nc_fg)print*,"eznc_put_2Dchar:",VarName
      count1=end1-start1+1
      count2=end2-start2+1
...
! INTERNAL VARIABLES
      ...
      IF(debug_nc_fg)print*,"eznc_put_3Dint:",VarName
...
! INTERNAL VARIABLES
      ...
      IF(debug_nc_fg) print*,"eznc_put_3Dreal:",VarName
...
!
* -------------------------------
      SUBROUTINE eznc_put_0Dint_into1D(ncid,VarName,inval,start1)
...
!      REAL,DIMENSION(start1) :: ncvals
      ...
      IF(debug_nc_fg)print*,"eznc_put_0Dint_into1D:",VarName,inval
...
! if file is in DEFINE mode, switch to DATA mode and try again
     ...
     $                        count=(/count1/))
      ...
      END SUBROUTINE eznc_put_0Dint_into1D
...
!      REAL,DIMENSION(start1) :: ncvals
      ...
      IF(debug_nc_fg)print*,"eznc_put_0Dreal_into1D:",VarName,inval
...
* -------------------------------
      SUBROUTINE eznc_put_0Dint_into2D(ncid,VarName,inval,
     &                                       start1,start2)
...
! INTERNAL VARIABLES
      ...
      IF(debug_nc_fg)print*,"eznc_put_0Dint_into2D:",VarName,inval
...
! if file is in DEFINE mode, switch to DATA mode and try again
     ...
     $                        count=(/count1,count2/))
      ...
      END SUBROUTINE eznc_put_0Dint_into2D
* -------------------------------
...
! INTERNAL VARIABLES
      ...
      IF(debug_nc_fg)print*,"eznc_put_0Dreal_into2D:",VarName,inval
...
! INTERNAL VARIABLES
      ...
      IF(debug_nc_fg)print*,"eznc_get_globalatt : ",AttName,ncid
...
! INTERNAL VARIABLES
      ...
      IF(debug_nc_fg)print*,"eznc_get_dimid: ", DimName,": dimid=",dimid
...
! INTERNAL VARIABLES
      ...
      IF(debug_nc_fg)print*,"eznc_get_0Dint: ",VarName
...
! INTERNAL VARIABLES
      ...
      IF(debug_nc_fg)print*,"eznc_get_0Dreal: ",VarName
...
! INTERNAL VARIABLES
      ...
      IF(debug_nc_fg)print*,"eznc_get_1Dint: ",VarName
...
! INTERNAL VARIABLES
      ...
      IF(debug_nc_fg)print*,"eznc_get_1Dreal: ",VarName
...
! INTERNAL VARIABLES
      ...
      IF(debug_nc_fg)print*,"eznc_get_1Dchar: ",VarName
...
! INTERNAL VARIABLES
      ...
      IF(debug_nc_fg)print*,"eznc_get_2Dint: ",VarName
...
! INTERNAL VARIABLES
      ...
      IF(debug_nc_fg)PRINT*,"eznc_get_2Dreal:",VarName,count1,count2
...
! INTERNAL VARIABLES
      ...
      IF(debug_nc_fg) print*,"eznc_get_3Dreal: ",VarName
      count1=end1-start1+1
      count2=end2-start2+1
      count3=end3-start3+1
